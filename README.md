...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f9037486-880e-4137-8e46-9205e0cb003c
```

> `f9037486-880e-4137-8e46-9205e0cb003c` is the password of the certificate, you can change it to any password you want.
